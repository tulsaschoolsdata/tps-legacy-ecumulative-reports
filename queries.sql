-- Drop Schema
IF exists(SELECT * FROM sys.schemas WHERE name = 'ecum_queries')
BEGIN
    -- https://stackoverflow.com/a/15403866/1596013
    DECLARE @DropCommand nVarChar(MAX) = ''

    SELECT @DropCommand = @DropCommand + 'DROP PROCEDURE '+ QUOTENAME(S.name) + '.' + QUOTENAME(T.name) + '; '
    FROM sys.procedures AS T JOIN sys.schemas AS S ON S.schema_id = T.schema_id
    WHERE S.name = 'ecum_queries'

    SELECT @DropCommand = @DropCommand + 'DROP VIEW '+ QUOTENAME(S.name) + '.' + QUOTENAME(T.name) + '; '
    FROM sys.views AS T JOIN sys.schemas AS S ON S.schema_id = T.schema_id
    WHERE S.name = 'ecum_queries'

    EXEC (@DropCommand)
    DROP SCHEMA ecum_queries
...
FROM
  ...
  INNER JOIN ECUM_Report_Student.ECUM.BUILDING_MASTER ON (ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_KEY=ECUM_Report_Student.ECUM.STUDENT.STUDENT_CURR_SCH)
WHERE
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ACTTEST ON (
    ECUM_Report_Student.ECUM.TESTS_ACTTEST.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_ACTTEST.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_ACTTEST.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_ACTTEST.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
SELECT
  ...
  CASE WHEN ECUM_Report_Student.ECUM.TESTS_EOI.BIOL_PASS_FAIL IN ('P','Y') THEN 'Pass'
       ...
       ELSE '  '
       END AS BIOL_PASS_FAIL
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_EOI ON (
    ECUM_Report_Student.ECUM.TESTS_EOI.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_EOI.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_EOI.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_EOI.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_EXPLTEST ON (
    ECUM_Report_Student.ECUM.TESTS_EXPLTEST.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_EXPLTEST.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_EXPLTEST.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_EXPLTEST.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ITBS_CUSTOM ON (
    ECUM_Report_Student.ECUM.TESTS_ITBS_CUSTOM.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_ITBS_CUSTOM.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_ITBS_CUSTOM.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_ITBS_CUSTOM.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_NAGL ON (
    ECUM_Report_Student.ECUM.TESTS_NAGL.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_NAGL.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_NAGL.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_NAGL.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_NEWITBS_CUSTOM ON (
    ECUM_Report_Student.ECUM.TESTS_NEWITBS_CUSTOM.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_NEWITBS_CUSTOM.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_NEWITBS_CUSTOM.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_NEWITBS_CUSTOM.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_OCC_CUSTOM ON (
    ECUM_Report_Student.ECUM.TESTS_OCC_CUSTOM.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_OCC_CUSTOM.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_OCC_CUSTOM.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_OCC_CUSTOM.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_OTIS ON (
    ECUM_Report_Student.ECUM.TESTS_OTIS.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_OTIS.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_OTIS.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_OTIS.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_PBP ON (
    ECUM_Report_Student.ECUM.TESTS_PBP.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_PBP.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_PBP.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_PBP.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_PLANTEST ON (
    ECUM_Report_Student.ECUM.TESTS_PLANTEST.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_PLANTEST.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_PLANTEST.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_PLANTEST.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_READING_CUSTOM ON (
    ECUM_Report_Student.ECUM.TESTS_READING_CUSTOM.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_READING_CUSTOM.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_READING_CUSTOM.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_READING_CUSTOM.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_SATCOLL ON (
    ECUM_Report_Student.ECUM.TESTS_SATCOLL.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_SATCOLL.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_SATCOLL.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_SATCOLL.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_ADMINISTERED ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER)
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_SAT9_CUSTOM ON (
    ECUM_Report_Student.ECUM.TESTS_SAT9_CUSTOM.STUDENT_NUMBER=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.TESTS_SAT9_CUSTOM.SEQ_NUM=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.SEQ_NUM AND
    ECUM_Report_Student.ECUM.TESTS_SAT9_CUSTOM.TYPE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE AND
    ECUM_Report_Student.ECUM.TESTS_SAT9_CUSTOM.DATE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.DATE AND
    ECUM_Report_Student.ECUM.TESTS_SAT9_CUSTOM.GRADE=ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.GRADE
  )
  INNER JOIN ECUM_Report_Student.ECUM.TESTS_TEST ON (ECUM_Report_Student.ECUM.TESTS_ADMINISTERED.TYPE=ECUM_Report_Student.ECUM.TESTS_TEST.TEST_TYPE)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.ADDHIST_CICSTST1 ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.ADDHIST_CICSTST1.STUDENT_NUMBER)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
SELECT
  ...
  ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_NAME
FROM
  ECUM_Report_Student.ECUM.BUILDING_MASTER
  INNER JOIN ECUM_Report_Student.ECUM.ATTEND_CUSTOM ON (ECUM_Report_Student.ECUM.ATTEND_CUSTOM.SCHOOL=ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_KEY)
...
FROM
  ECUM_Report_Student.ECUM.MOBILITY
  INNER JOIN ECUM_Report_Student.ECUM.STUDENT ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.MOBILITY.STUDENT_NUMBER)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.ELEMGRD_CICSTST1 ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.ELEMGRD_CICSTST1.STUDENT_NUMBER)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
SELECT
  ...
  CASE WHEN ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_ALTERNATE_LOCATION = '   ' THEN ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_COURSE_NAME
  ...
  CASE WHEN ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_SEMESTER = 'F' THEN 'FALL'
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.STUDENT_NUMBER)
WHERE
  (
   ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
   AND
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.SRECUM_CICSTST1 ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.SRECUM_CICSTST1.STUDENT_NUMBER)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.BUILDING_MASTER  Alias_STUDENT_ECUM_BUILDING_MASTER ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_CURR_SCH=Alias_STUDENT_ECUM_BUILDING_MASTER.BLDG_KEY)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
SELECT
  ...
  CASE WHEN ECUM_Report_Student.ECUM.SCMISC_CICSTST1.OKLA_SCHOLARS = 'Y' THEN '** Oklahoma Academic Scholar'
       ELSE '  '
       END OKLA_SCHOLARS
FROM
...
FROM
  ECUM_Report_Student.ECUM.STUDENT
  INNER JOIN ECUM_Report_Student.ECUM.STUDENT_DEMO ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.STUDENT_DEMO.STUDENT_NUMBER)
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
FROM
  ...
  LEFT OUTER JOIN (
    SELECT DISTINCT
      ...
      ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_NAME
    FROM
      ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM
      INNER JOIN ECUM_Report_Student.ECUM.BUILDING_MASTER ON (ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_LOCATION = ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_KEY)
    WHERE ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_SEMESTER = 'F'
  ) Table__15 ON (
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.STUDENT_NUMBER=Table__15.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_FROM_YEAR=Table__15.HIST_FROM_YEAR AND
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_TO_YEAR=Table__15.HIST_TO_YEAR AND
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_GRADE_LEVEL=Table__15.HIST_GRADE_LEVEL
  )
  LEFT OUTER JOIN (
    SELECT DISTINCT
      ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.STUDENT_NUMBER,
    ...
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.STUDENT_NUMBER=Table__16.STUDENT_NUMBER AND
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_FROM_YEAR=Table__16.HIST_FROM_YEAR AND
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_TO_YEAR=Table__16.HIST_TO_YEAR AND
    ECUM_Report_Student.ECUM.CLASS_HISTORY_CUSTOM.HIST_GRADE_LEVEL=Table__16.HIST_GRADE_LEVEL
  )
WHERE
  ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER = @student_number
GO
...
FROM
  ECUM_Report_Student.ECUM.SCMISC_CICSTST1
  RIGHT OUTER JOIN ECUM_Report_Student.ECUM.STUDENT ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.SCMISC_CICSTST1.STUDENT_NUMBER)
...
SELECT
  ...
  CASE WHEN ECUM_Report_Student.ECUM.MOBILITY.TRANSFER_CODE = '  ' THEN ECUM_Report_Student.ECUM.MOBILITY.ENTRY_REASON_CODE
       ELSE ECUM_Report_Student.ECUM.MOBILITY.ENTRY_REASON_CODE+'-'+ECUM_Report_Student.ECUM.MOBILITY.TRANSFER_CODE
       END ENTRY_TRANSFER_REASON_CODE,
...
FROM
  ECUM_Report_Student.ECUM.BUILDING_MASTER
  RIGHT OUTER JOIN ECUM_Report_Student.ECUM.MOBILITY ON (ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_KEY=ECUM_Report_Student.ECUM.MOBILITY.SCHOOL_CODE)
...
FROM
  MFLegacy_Student.TSTU_Yr0809.HEALTH
  RIGHT OUTER JOIN ECUM_Report_Student.ECUM.STUDENT ON (MFLegacy_Student.TSTU_Yr0809.HEALTH.STUDID=ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER)
...
SELECT
  ECUM_Report_Student.ECUM.SPED_CICSTST1.SPEC_PREFIX+
  ECUM_Report_Student.ECUM.SPED_CICSTST1.SPEC_NUMBER as SPEC_PREFIX_NUMBER,

  ECUM_Report_Student.ECUM.SPED_CICSTST1.SPEC_PROG_DESIGN,
  ECUM_Report_Student.ECUM.SPED_CICSTST1.SPEC_ENTRY_DATE
FROM
  ECUM_Report_Student.ECUM.SPED_CICSTST1
  RIGHT OUTER JOIN ECUM_Report_Student.ECUM.STUDENT ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.SPED_CICSTST1.STUDENT_NUMBER)
...
SELECT
  ...
  ECUM_Report_Student.ECUM.STUDENT_DEMO.SPARENT_MNAME
FROM
  ECUM_Report_Student.ECUM.STUDENT_DEMO
  RIGHT OUTER JOIN ECUM_Report_Student.ECUM.STUDENT ON (ECUM_Report_Student.ECUM.STUDENT.STUDENT_NUMBER=ECUM_Report_Student.ECUM.STUDENT_DEMO.STUDENT_NUMBER)
