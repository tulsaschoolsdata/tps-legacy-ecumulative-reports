...
SELECT
  ...
  ECUM_Report_Student.ECUM.MOBILITY.SCHOOL_CODE,
  ECUM_Report_Student.ECUM.MOBILITY.ENTRY_DATE,
  CASE  WHEN ECUM_Report_Student.ECUM.MOBILITY.TRANSFER_CODE = '  ' THEN ECUM_Report_Student.ECUM.MOBILITY.ENTRY_REASON_CODE ELSE ECUM_Report_Student.ECUM.MOBILITY.ENTRY_REASON_CODE+'-'+ECUM_Report_Student.ECUM.MOBILITY.TRANSFER_CODE END as "ENTRY_TRANSFER_REASON_CODE",
  ECUM_Report_Student.ECUM.MOBILITY.EXIT_DATE,
  ECUM_Report_Student.ECUM.MOBILITY.EXIT_REASON_CODE,
  ECUM_Report_Student.ECUM.BUILDING_MASTER.BLDG_NAME
FROM
